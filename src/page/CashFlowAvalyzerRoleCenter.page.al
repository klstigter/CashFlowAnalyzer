...
page 57200 "Opt. Cashflow Analyser RC"
{
    // CurrPage."Help And Setup List".ShowFeatured;

    Caption = 'Cashflow Analyser Role Center';
    PageType = RoleCenter;
...
#pragma warning restore AS0072
        ...
        area(sections)
        {
            ...
            group(CashflowAnalyzer)
            {
                ...
                action("Cashflow Analyzer List")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Cashflow Analyzers';
                    RunObject = Page "Opt. CashFlow Analyzer List";
                    ToolTip = 'View and manage your cash flow analyses to forecast your company''s cash position based on various financial data sources.';
                }
            }
        }
    }
